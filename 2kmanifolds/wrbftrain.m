function [net, options] = rbftrain(net, options, x, t, w)
%WRBFTRAIN Weighted version of Netlab's RBFTRAIN
% 
% WRBTRAIN adds an extra input argument W which is a vector of weights
% for each of the input points in x.  See below for the description of
% RBFTRAIN
% 
